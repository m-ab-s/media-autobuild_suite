...
if [0]==[%zlibINI%] (
    ...
    echo.
    echo. Build zlib?
    echo. 1 = No, use msys2 package when needed [Recommended]
    echo. 2 = Yes, build zlib
    echo. 3 = Yes, build zlib (Chromium fork^)
    echo. 4 = Yes, build zlib (Cloudflare fork^)
    echo. 5 = Yes, build zlib-ng
    echo.
...
if %buildzlib%==1 set "zlib=n"
if %buildzlib%==2 set "zlib=y"
if %buildzlib%==3 set "zlib=chromium"
if %buildzlib%==4 set "zlib=cloudflare"
if %buildzlib%==5 set "zlib=ng"
if %buildzlib% GTR 5 GOTO zlib

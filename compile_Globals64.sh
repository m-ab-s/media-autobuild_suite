...
if [ -f "$LOCALDESTDIR/lib/libturbojpeg.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libjpeg-turbo 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libjpeg.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile jpeg-9 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libjasper.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile jasper 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libtiff.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile tiff 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libasprintf.a" ]; then
    ...
    echo -------------------------------------------------
		...
		echo -ne "\033]0;compile gettext-runtime 64Bit\007"
...
if [ -f "$LOCALDESTDIR/bin/msgmerge.exe" ]; then
    ...
    echo -------------------------------------------------
		...
		echo -ne "\033]0;compile gettext-static 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libfreetype.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile freetype 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libgcrypt.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libgcrypt 64Bit\007"
...
if [ -f "$LOCALDESTDIR/bin/rtmpdump.exe" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile rtmpdump 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/liblzo2.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile lzo 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libdca.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libdca 64Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libxml2.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libxml2 64Bit\007"
...
if [[ $qt4 = "y" ]]; then
	if [ -f "$LOCALDESTDIR/bin/designer.exe" ]; then
		...
		echo -------------------------------------------------
			...
			echo -ne "\033]0;compile qt4 64Bit\007"

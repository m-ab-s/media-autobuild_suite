...
if [ -f "$LOCALDESTDIR/lib/libgsm.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling gsm 32Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libogg.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling libogg 32Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libvorbis.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling libvorbis 32Bit\007"
...
if [ -f "libtheora-1.1.1/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling libtheora 32Bit\007"
...
if [ -f "speex-1.2rc1/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling speex 32Bit\007"
...
if [ -f "flac-1.3.0/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling flac 32Bit\007"
...
if [ -f "lame-3.99.5/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling lame 32Bit\007"
...
if [ -f "vo-aacenc-0.1.3/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling vo-aacenc 32Bit\007"
...
if [ -f "opencore-amr-0.1.3/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling opencore-amr 32Bit\007"
...
if [ -f "vo-amrwbenc-0.1.2/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling vo-amrwbenc 32Bit\007"
...
if [ -f "bin-fdk-aac/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling fdk-aac 32Bit\007"
		cd $LOCALBUILDDIR
...
if [ -f "faac-1.28/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling faac 32Bit\007"
...
if [ -f "opus-1.0.3/compile.done" ]; then
    ...
    echo -------------------------------------------------
		...
		echo -ne "\033]0;compiling opus 32Bit\007"

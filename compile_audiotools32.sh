...
if [ -f "$LOCALDESTDIR/lib/libgsm.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile gsm 32Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libogg.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libogg 32Bit\007"
...
if [ -f "$LOCALDESTDIR/lib/libvorbis.a" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libvorbis 32Bit\007"
...
if [ -f "opus-tools-0.1.7/compile.done" ]; then
    ...
    echo -------------------------------------------------
		...
		echo -ne "\033]0;compile opus-tools 32Bit\007"
...
if [ -f "a52dec-0.7.4/compile.done" ]; then
	...
	echo -ne "\033]0;compile a52dec 32Bit\007"
...
if [ -f "libmad-0.15.1b/compile.done" ]; then
	...
	echo -------------------------------------------------
		...
		echo -ne "\033]0;compile libmad 32Bit\007"
